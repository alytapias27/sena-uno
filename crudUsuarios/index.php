					...
					<div class="menu"> 
						<div class="botones"> <!-- Contenedor botones de accion -->
							...
							<center> <!-- Etiqueta para centrar -->
								...
								<br><br>
								<button class="btn btn"><a href="../crudclientes/index.php">CrudClientes</a></button> <!-- Boton uno -->
								<br><br>
								<button class="btn btn"><a href="../crudcontactenos/index.php">CrudContactenos</a></button> <!-- Boton dos -->
								<br><br>
								<button class="btn btn"><a href="../crudUsuarios/index.php">CrudUsuario</a></button> <!-- Boton tres-->
								<br><br>
								<button class="btn btn"><a href="../cruddatos/index.php">CrudDatosPersonales</a></button> <!-- Boton cuatro-->
								<br><br>
								<button class="btn btn"><a href="../crudadmin/index.php">CrudAdministrador</a></button> <!-- Boton cinco -->
								<br><br>
				...
				<div class="contenido"> <!-- Contenedor contenido -->
					...
					<div class="conten-tablas"> <!-- Contenedor padre -->
						...
						<div class="contenedor"> <!-- Contenedor principal -->
							...
							<h2 class="title-uno">Usuarios</h2> <!-- Titulo -->
